var game = new Phaser.Game(800,600, Phaser.AUTO, 'C10_game', {preload: preload, create: create, update: update, render: render});
...
function preload() {
    game.load.image('starfield', 'back.png');
    game.load.image('ship', 'xwing.png');
    game.load.image('bullet', 'bullet0.png');
    game.load.image('enemy-green', 'tie.png');
    game.load.image('enemy-blue', 'advTie.png');
    game.load.image('blueEnemyBullet', 'bullet0.png');
    game.load.spritesheet('explosion', 'explode.png', 128, 128);
    game.load.bitmapFont('spacefont', 'font.png');
